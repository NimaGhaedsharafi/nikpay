...
class MellatConfig implements PaymentConfig
{
    /**
     ...
     * @var string
     */
    protected $webServiceUrl = 'https://pgws.bpm.bankmellat.ir/pgwchannel/services/pgw?wsdl';
     ...
     * @var string
     */
    protected $gatewayUrl = 'https://pgw.bpm.bankmellat.ir/pgwchannel/startpay.mellat';
